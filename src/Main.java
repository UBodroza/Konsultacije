        ...
        for (int sector = 1; sector <= 5; sector++) {
            ...
            if (RANDOM.nextInt(100) < 80) {
                ...
                while (!enemyDefeated && !enemyEscaped) {
                    ...
                    System.out.println("3. Attempt to Escape");
                    ...
                    switch (choice) {
                        ...
                        case 2:
                            ...
                            int rocketDamage = 30 + RANDOM.nextInt(11); // 30-40 dmg
                    ...
                    if (!enemyDefeated && !enemyEscaped) {
                        boolean enemyHit = RANDOM.nextInt(100) < 70; // 70% chance for enemy hit
                        if (enemyHit) {
                            int enemyDamage = 10 + RANDOM.nextInt(6); // 10-15 damage
                            shieldEnergy = shieldEnergy - enemyDamage;
                            System.out.printf("Your shield energy is depleted. You've taken %d damage. \n", enemyDamage);
                            if (shieldEnergy <= 0) {
                ...
                System.out.println("Sector is clear, you pass through safely.");
            }
